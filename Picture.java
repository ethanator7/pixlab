...
public class Picture extends SimplePicture 
{
    ...
    public void createCollage()
    {
        ...
        this.copy(flower1,0,60,80,10);
        this.copy(flower2,100,0,25,25);
        this.copy(flower1,200,0,50,50);
        Picture flowerNoBlue = new Picture(flower2);
        flowerNoBlue.zeroBlue();
        this.copy(flowerNoBlue,300,0,75,75);
        this.copy(flower1,400,0,100,60);
        this.copy(flower2,500,0,100,75);
        this.mirrorVertical();
    ...
    public void myCollage() {
        ...
        this.copy(robot,0,0);
        Picture robotGrayscale = new Picture(robot);
        robotGrayscale.grayscale();
        this.copy(robotGrayscale,100,0);
    ...
    public void edgeDetectionTopToBottom(int edgeDist)
    {
        Pixel topPixel = null;
        Pixel bottomPixel = null;
        Pixel[][] pixels = this.getPixels2D();
